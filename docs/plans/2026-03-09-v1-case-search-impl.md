# V1 Case Search Script Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Create a self-contained script implementing V1 case search with world model cycles using existing modular protocols.

**Architecture:** `V1WorldModel` wraps `WorldModelManager` to implement `WorldModel` protocol. `V1PromptBuilder` handles V1-style prompt routing. `V1SequentialExecutor` runs cycles with dual stagnation detection.

**Tech Stack:** Python 3.12, existing `k_search.modular` protocols, `k_search.kernel_generators.world_model_manager`, OpenAI SDK.

**Note:** No commits during implementation. User will commit when ready.

---

## Task 1: Create script directory and stub

**Files:**
- Create: `scripts/gpu_mode_modular_k_search/__init__.py`
- Create: `scripts/gpu_mode_modular_k_search/run.py`

**Step 1: Create directory**

```bash
mkdir -p scripts/gpu_mode_modular_k_search
```

**Step 2: Create empty __init__.py**

```python
# scripts/gpu_mode_modular_k_search/__init__.py
```

**Step 3: Create run.py with imports and CycleConfig**
...
Run: `python -c "from scripts.gpu_mode_case_search.run import CycleConfig; print('OK')"`
Expected: "OK"

---

## Task 2: Implement V1WorldModel wrapper

**Files:**
- Modify: `scripts/gpu_mode_modular_k_search/run.py`

**Step 1: Add V1WorldModel class after CycleConfig**
...
Run: `python -c "from scripts.gpu_mode_case_search.run import V1WorldModel; print('OK')"`
Expected: "OK"

---

## Task 3: Implement V1PromptBuilder

**Files:**
- Modify: `scripts/gpu_mode_modular_k_search/run.py`

**Step 1: Add V1PromptBuilder class after V1WorldModel**
...
Run: `python -c "from scripts.gpu_mode_case_search.run import V1PromptBuilder; print('OK')"`
Expected: "OK"

---

## Task 4: Implement V1SequentialExecutor

**Files:**
- Modify: `scripts/gpu_mode_modular_k_search/run.py`

**Step 1: Add V1SequentialExecutor class after V1PromptBuilder**
        ...
        while rounds_used < self._max_rounds:
            ...
            self._world_model.update(
                ...
                context={
                    ...
                    "node": node,  # Pass modular Node for metadata reads
...
Run: `python -c "from scripts.gpu_mode_case_search.run import V1SequentialExecutor; print('OK')"`
Expected: "OK"

---

## Task 5: Implement CLI main()

**Files:**
- Modify: `scripts/gpu_mode_modular_k_search/run.py`

**Step 1: Add create_llm_call and main() at end of file**
...
Run: `python scripts/gpu_mode_modular_k_search/run.py --help`
Expected: Shows argument help without errors

---

## Task 6: Create minimal test file

**Files:**
- Create: `scripts/gpu_mode_modular_k_search/test_run.py`

**Step 1: Write test for core cycle stagnation logic**
...
from scripts.gpu_mode_case_search.run import CycleConfig, V1SequentialExecutor
...
def test_stagnation_ends_cycle_early():
    ...
    # get_action_context now takes a Node, not a string
...
Run: `pytest scripts/gpu_mode_modular_k_search/test_run.py -v`
Expected: PASS
...
Run: `ruff check scripts/gpu_mode_modular_k_search/`
Fix any issues reported.

**Step 2: Run ruff format**

Run: `ruff format scripts/gpu_mode_modular_k_search/`
...
Plan complete and saved to `docs/plans/2026-03-09-v1-case-search-impl.md`. Two execution options:
