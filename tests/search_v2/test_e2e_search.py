"""E2E integration test: search_v2 with real GPU evaluation."""
...
class TestE2ESearch:
    """E2E tests validating search_v2 loop with real GPU evaluation."""
    ...
    def test_single_round_with_valid_code(self, task_dir: Path, valid_triton_code: str):
        ...
        result = run_search(adapter, evaluator, mock_llm, config)
