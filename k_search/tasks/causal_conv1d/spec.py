"""Causal Conv1d kernel specification for LLM prompts."""
...
def _read_reference_kernel() -> str:
    """Load FLA reference kernel code for inclusion in prompts."""
    try:
        import inspect
        import re
        ...
        # Extract causal_conv1d_fwd_kernel function (from @triton decorators to next top-level def)
...
Test Cases (optimize runtime for these):
